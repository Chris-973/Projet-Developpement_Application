...
Christopher : -> réalisation du CDUC v2 et du cahier des tests v1 +
Yann : -> réalisation du GANTT v2 et du cahier des tests v1 +
Ruben : -> réalisation du GANTT v3 et du cahier des tests v1
